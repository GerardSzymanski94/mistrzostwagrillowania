...
@section('content')
    ...
    <a class="btn btn-primary" href="{{ route('admin2.forms' ) }}">Powrót</a>
    ...
    <br>
    {{--  <a class="btn btn-success" href="{{ route('admin2.dashboard.confirmUser', ['user'=>$form->id]) }}">Potwierdź wygraną</a>--}}
