...
@section('content')
    ...
    @isset($b)
        ...
        Szukany paragon: {{ $b }}
    @endisset
    <a class="btn btn-primary" href="{{ route('admin2.getcsv') }}"> Export zgłoszeń do CSV </a>
    <table class="table table-striped">
        ...
        @foreach($registers as $register)
            <tr>
                ...
                <th><a class="btn btn-primary" href="{{ route('admin2.form', ['form'=>$register->id]) }}">Szczegóły</a></th>
            </tr>
        @endforeach
    </table>
