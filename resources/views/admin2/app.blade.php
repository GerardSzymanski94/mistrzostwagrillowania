        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title" style="border: 0;">
                    <a href="{{ route('admin2.index') }}" class="site_title"><span>{{ env('APP_NAME') }}</span></a>
                </div>
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li>
                                <a href="{{ route('admin2.index') }}"><i class="fa fa-home"></i> Wszystkie zgłoszenia</a>
                            </li>
                            <li>
                                <a href="{{ route('admin2.forms') }}"><i class="fa fa-home"></i> Wypełnione formularze</a>
                            </li>
                        </ul>
                    </div>
