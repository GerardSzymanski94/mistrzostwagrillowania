    ...
    <div id="video-wrap" class="video-wrap" style="overflow: auto">
        <div class="container">
                            ...
                            <div class="col-xl-12 col-md-12">
                                ...
                                <div class="row" style="margin-bottom: 30px;">
                                    <div class="col-sm-12" style="font-size: 13px;">
                                            ...
                                            <span>
                                                TWOJE ZGŁOSZENIE ZOSTAŁO WYBRANE PRZEZ KOMISJĘ KONKURSOWĄ. ABY OTRZYMAĆ <b>NAGRODĘ III STOPNIA,</b> MUSIMY ZWERYFIKOWAĆ TWOJE
                                ...
                                <form action="{{ route('confirmform') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-lg-6 col-sm-12">
                                            <div class="form-group regi-paragon text-left">
                                                ...
                                                <input name="surname" type="text" class="form-control"
                                                       placeholder="NAZWISKO" required style="margin-bottom: 0"
                                                       value="{{ old('surname') }}">
                                        ...
                                        <div class="col-lg-4 col-sm-12">
                                            <div class="form-group regi-paragon text-left">
                                                ...
                                                <input name="email" type="email" class="form-control"
                                                       placeholder="ADRES E-MAIL ZGŁOSZENIA" required
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group regi-paragon text-left">
                                                ...
                                                <input name="paragon" type="file" class="form-control" required
                                                       style="margin-bottom: 0">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label> <input type="checkbox" name="rule1" required/>
                                                    Laureat oświadcza, że zapoznał się z <a
                                                            href="{{ asset('pdf/regulamin.pdf') }}" target="_blank"><b>Regulaminem
                                                            Konkursu</b></a>
                                                    i akceptuje jego treść, zgodnie z zastrzeżeniem pkt. 3.1. Regulaminu
                                                    nie jest pracownikiem Organizatora Konkursu tj. HJ HEINZ Polska sp.
                                                    z o. o. ani pracownikiem Organizatora Wykonawczego - AFEKT
                                                    sp. z o.o., ani nie jest pracownikiem Punktu Sprzedaży, a także nie
                                                    jest członkiem najbliższej rodziny tych osób, ma ukończone
                                                    18 lat i posiada pełną zdolność do czynności prawnych oraz jest
                                                    konsumentem na terenie Rzeczypospolitej Polskiej.
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <button type="submit"
                                                    class="btn text-white text-uppercase special-input btn-send-form"
                                                    style="background:#fff; color:#dd1d21 !important;">Zapisz
                                            </button>
                                        </div>
                                    </div>
                                </form>
            ...
            <div class="row" style="height: auto; margin-top: 30px;">
                <div class="col-md-4">
                    <p class="copyright"><br/><br/><a target="_blank" href="https://www.heinz.eu/privacy-notice">Polityka
                            prywatności</a>
                        &nbsp; | &nbsp; <a target="_blank" href="http://wszystkoociasteczkach.pl/po-co-sa-ciasteczka/">Cookies</a>
                    </p>
                </div>
                ...
                <div class="col-md-4">
                    <p class="copyright order-2 order-lg-3"><br/><br/>ORGANIZATOREM WYKONAWCZYM KONKURSU JEST AFEKT SP.
                        Z O.O.</p>
                </div>
            </div>
